...
def update_line_chart(clickdata,years):
    if clickdata:
        ...
        fig4.update_layout(title=f"Unemployment Rate in {clickedcountry}  Since {year_0}",xaxis=dict(showgrid=False),yaxis=dict(showgrid=False),
                        hovermode='x unified', plot_bgcolor='#000000',paper_bgcolor='#000000' ,showlegend=False,height=600 ,width=950)
        ...
        filtered_df2=filtered_df2[filtered_df2['Country']=='United States']
        ...
        fig5.update_layout(title=f"Unemployment Rate in United States Since {year_0}",xaxis=dict(showgrid=False),yaxis=dict(showgrid=False),
                        hovermode='x unified', plot_bgcolor='#000000',paper_bgcolor='#000000' ,showlegend=False,height=600,width=950)
